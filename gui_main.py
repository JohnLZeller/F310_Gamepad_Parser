...
class GUI():
	...
	self.root = tk.Tk()
        ...
        self.label_Packet = tk.Label(self.root, text="Packets coming from controller (Bytes 0-7)").grid(row=29, columnspan=8, pady=10)
        self.label_Packet0 = tk.Label(self.root, text="Byte 0").grid(row=30, column=0, padx=5, sticky="E")
        self.label_Packet1 = tk.Label(self.root, text="Byte 1").grid(row=30, column=1, padx=5, sticky="E")
        self.label_Packet2 = tk.Label(self.root, text="Byte 2").grid(row=30, column=2, padx=5, sticky="E")
        self.label_Packet3 = tk.Label(self.root, text="Byte 3").grid(row=30, column=3, padx=5, sticky="E")
        self.label_Packet4 = tk.Label(self.root, text="Byte 4").grid(row=30, column=4, padx=5, sticky="E")
        self.label_Packet5 = tk.Label(self.root, text="Byte 5").grid(row=30, column=5, padx=5, sticky="E")
        self.label_Packet6 = tk.Label(self.root, text="Byte 6").grid(row=30, column=6, padx=5, sticky="E")
        self.label_Packet7 = tk.Label(self.root, text="Byte 7").grid(row=30, column=7, padx=5, sticky="E")
        ...
        self.variable_Packet0.grid(row=31, column=0, sticky="E")
        self.variable_Packet1.grid(row=31, column=1, sticky="E")
        self.variable_Packet2.grid(row=31, column=2, sticky="E")
        self.variable_Packet3.grid(row=31, column=3, sticky="E")
        self.variable_Packet4.grid(row=31, column=4, sticky="E")
        self.variable_Packet5.grid(row=31, column=5, sticky="E")
        self.variable_Packet6.grid(row=31, column=6, sticky="E")
        self.variable_Packet7.grid(row=31, column=7, sticky="E")
        # Start tracking time
